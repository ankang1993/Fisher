...
<table width="960" align="center"
    ...
    <tr>
        <td colspan="3">
            ...
            <p align="center">
                <span class="pt11">
                    这仅仅是一个Java EE的框架程序。应用模拟一个简单的工作流系统。系统包含两个角色：<br>
                    普通员工的功能包括员工出勤打卡，员工的人事异动申请，员工查看工资单；<br>
                    经理的功能包括管理部门员工，签核申请，每月工资自动结算等。
                </span>
            </p>
            <p align="center" class="pt11">
                应用模拟了简单的工作流，使用的轻量级Java EE架构。技术包括：Struts 2.3、Spring 4.0、Hibernate 4.3、Quartz2.2。<br>
            ...
            <p align="center" class="pt11">本程序版权属于AK<br>
                参考自李刚轻量级Java EE企业应用实战（第四版）的程序 <a href="http://www.crazyit.org">http://www.crazyit.org</a><br>
            </p>
        </td>
    </tr>
</table>
